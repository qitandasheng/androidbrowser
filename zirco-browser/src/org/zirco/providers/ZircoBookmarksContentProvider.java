...
public class ZircoBookmarksContentProvider extends ContentProvider {
	...
	private static final String INI_DATA_SINA = "INSERT INTO " + BOOKMARKS_TABLE + "(" + 
	                    Browser.BookmarkColumns.TITLE + "," +
	                    Browser.BookmarkColumns.URL + "," +
	                    Browser.BookmarkColumns.BOOKMARK + ") VALUES (" + 
	                    "'ÐÂÀËÍø','www.sina.com.cn',1);";
	private static final String INI_DATA_TAOBAO = "INSERT INTO " + BOOKMARKS_TABLE + "(" + 
            Browser.BookmarkColumns.TITLE + "," +
            Browser.BookmarkColumns.URL + "," +
            Browser.BookmarkColumns.BOOKMARK + ") VALUES (" + 
            "'ÌÔ±¦Íø','www.taobao.com',1);";
	private static final String INI_DATA_IFENG = "INSERT INTO " + BOOKMARKS_TABLE + "(" + 
            Browser.BookmarkColumns.TITLE + "," +
            Browser.BookmarkColumns.URL + "," +
            Browser.BookmarkColumns.BOOKMARK + ") VALUES (" + 
            "'·ï»ËÍø','www.ifeng.com',1);";
	...
	private static class DatabaseHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			...
			db.execSQL(INI_DATA_SINA);
			db.execSQL(INI_DATA_TAOBAO);
			db.execSQL(INI_DATA_IFENG);
		}
